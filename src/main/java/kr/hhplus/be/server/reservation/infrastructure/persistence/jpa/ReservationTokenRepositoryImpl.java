...
public class ReservationTokenRepositoryImpl implements ReservationTokenRepository {
    ...
    @Override
    public List<ReservationToken> findByIdInAndStatus(List<UUID> tokenIds, ReservationTokenStatus status) {
        return jpaRepository.findByIdInAndStatus(tokenIds, status);
    }

    @Override
    public Optional<ReservationToken> findByUserIdAndStatusIn(UUID userId, List<ReservationTokenStatus> statuses) {
        return jpaRepository.findByUserIdAndStatusIn(userId, statuses);
    }
